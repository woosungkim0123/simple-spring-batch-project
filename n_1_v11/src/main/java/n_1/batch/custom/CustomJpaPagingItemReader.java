...
/**
 * doReadPage() 메소드에서 트랜잭션을 제거한 CustomJpaPagingItemReader
 */
public class CustomJpaPagingItemReader <T> extends AbstractPagingItemReader<T> {
    ...
    public CustomJpaPagingItemReader() {
        setName(ClassUtils.getShortName(CustomJpaPagingItemReader.class));
    }
    ...
    protected void doOpen() throws Exception {
        ...
        // in CustomJpaPagingItemReader's managed transaction
        if (queryProvider != null) {

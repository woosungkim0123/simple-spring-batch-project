...
@TestPropertySource(properties = "job.name=jdbcExecuteBatchWriterBatchJob")
@SpringBootTest
@SpringBatchTest
class JdbcExecuteBatchWriterConfigurationTest {
    ...
    @DisplayName("JDBC ExecuteBatch를 이용하여 Writer를 개선한 배치가 정상적으로 실행된다.")
    @Test
    void batch_success_using_jdbc_executeBatch_writer() throws Exception {
        // given
